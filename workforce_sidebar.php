		 ...
		 <ul class="nav navbar-nav flex-row">                 
			 <li class="nav-item mr-auto">
				 <a class="navbar-brand" href="index.php">
					 <img class="brand-logo" alt="Chameleon admin logo" src="images/icon.png"/>             
					 <h3 class="brand-text">Euro Security </h3>
				 </a>
			 </li>
		 ...
		 <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">          
			 <li class="active">
				 <a href="workforce.php">
					 <i class="ft-home"></i>
					 <span class="menu-title" data-i18n="">Work Force Team</span>
				 </a>          
			 </li>
			 ...
			 <li class=" nav-item">
				 <a href="add-new-staff.php">
					 <i class="ft-plus"></i>
					 <span class="menu-title" data-i18n="">Add New Staff </span>
				 </a>          
			 </li>                           
		 </ul>      
	 </div>      
