                      ...
                      <div class="feather-icons overflow-hidden row">
						...
						?>	
                          ...
                          <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                            ...
                            <a href="client_roaster_details.php?client_id=<?php echo $crow['client_id'];?>"><label class="fonticon-classname"><?php echo $crow['client_name']; ?></label></a>
                            <label class="fonticon-unit"><?php echo $crow['client_phone']; ?></label>
                          </div>
                          <?php
