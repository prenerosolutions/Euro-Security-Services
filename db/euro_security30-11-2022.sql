...
(2, 'Atiq Ramzan', 'admin@prenero.com', '+923157524000', '123456', ' Noneczxczczc', 'Faisalabadxczczcxz', '25631211313', 'PAN2563123123', '2022-09-23 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `client_cost`
--
...
INSERT INTO `duties` (`duty_id`, `job_id`, `employee_code`, `guard_cost`, `duty_status`, `date_added`) VALUES
(1, 1, 1, 900, 'Present', '2022-09-22'),
(2, 1, 1, 900, 'Present', '2022-09-21'),
(7, 1, 1, 500, '', '2022-11-16'),
(8, 1, 2, 500, '', '2022-11-16'),
(9, 1, 2, 400, '', '2022-11-17');
...
CREATE TABLE `jobs` (
  ...
  `client_cost` varchar(55) NOT NULL,
  `date_added` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `jobs` (`job_id`, `site_id`, `job_title`, `start_time`, `end_time`, `break_time`, `job_date`, `client_cost`, `date_added`) VALUES
(1, 1, 'Day Shift', '12:45', '18:45', '1 hour', '2022-11-17', '900', '2022-11-09 02:53:48'),
(2, 1, 'Night Shift', '18:00', '22:00', '1 hours', '2022-11-19', '900', '2022-11-17 06:15:49'),
(3, 1, 'Night Shift', '18:00', '22:00', '1 hours', '2022-11-19', '900', '2022-11-17 06:17:24'),
(4, 1, 'Night Shift', '18:10', '22:00', '1 hours', '2022-11-24', '900', '2022-11-17 06:18:54'),
(5, 1, 'Night Shift', '18:10', '22:00', '1 hours', '2022-11-24', '900', '2022-11-17 06:19:25'),
(6, 1, 'Night Shift', '18:10', '22:00', '1 hours', '2022-11-24', '900', '2022-11-17 06:20:13');
...
INSERT INTO `salary` (`salary_id`, `employee_code`, `salary_paid_to`, `salary_amount`, `pay_month`, `pay_method`, `salary_status`) VALUES
(1, 2, 'Saqib', '1000', 'Oct-2022', 'cash', 'Paid'),
(2, 1, 'Atiq', '1200', 'Oct-2022', 'cash', 'Paid');
...
--
ALTER TABLE `duties`
  MODIFY `duty_id` int(55) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
