...
INSERT INTO `duties` (`duty_id`, `client_id`, `requirements`, `duty_timing`, `employee_name`, `guard_salary`, `client_cost`, `duty_status`, `date_added`) VALUES
(1, 2, '9am to 6pm', '9am to 6pm', 'Saqib', '500', '700', 'Present', '2022-09-22'),
(2, 1, '9am to 6pm', '9am to 6pm', 'Saqib', '500', '800', 'Present', '2022-09-21');
...
(2, 'Saqib', 'demo@prenero.com', '+923157524000', '12345678', 'Islam Nager Faisalabbad', 'Male Guard', '900.00', 'ESI12345', '10', 'PF1234', '6', 'PAN1234', NULL, NULL, NULL, NULL, NULL, '2022-09-04 12:17:57');
...
(2, 'Fsd', 2, 'Punjab', '9am to 6pm', 'female', '900', '2022-09-22');
...
--
ALTER TABLE `clients`
  MODIFY `client_id` int(55) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
